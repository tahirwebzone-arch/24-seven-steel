...
export default function Woodery() {
  const t = useTranslations('Woodery');
    ...
    <main>
      ...
      <section className="py-16 px-6 max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-3 gap-12">
          ...
          {/* Left Content Area - text-start handles alignment for RTL */}
