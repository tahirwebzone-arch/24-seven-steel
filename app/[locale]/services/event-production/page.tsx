...
export default function EventProduction() {
  ...
  return (
    <main>
      {/* Title stays in English as per your request */}
      <Hero 
        title={t('heroTitle')}
        imageSrc="/hero-event-production.png"
        showForm={false}
      />
      ...
      <section className="py-16 px-6 max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2 space-y-8 text-start">
            {/* The border flips from left to right in Arabic */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            {allImages.slice(0, visibleCount).map((i) => (
              <div key={i} className="group relative aspect-video overflow-hidden rounded-xl bg-gray-100">
                <Image 
                  src={`/portfolio/event-production-${i}.png`} 
                  alt={`Event Production ${i}`} 
                  fill 
